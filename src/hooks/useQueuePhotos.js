...
const useQueuePhotos = () => {
  ...
  const updateSinglePhoto = useCallback((id, updatedPhoto) => {
    setPhotos((prev) => prev.map((photo) => {
      ...
      return photo // Keep old reference
    }))
  }, [])
